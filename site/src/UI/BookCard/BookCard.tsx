...
import { ItemProps, BookStatus, GridDensity } from "../../Types/types";
...
const BookCard = ({ item, showActions, density = 'comfortable' }: { item: ItemProps; showActions?: boolean; density?: GridDensity }) => {
